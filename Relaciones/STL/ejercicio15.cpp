...
* @brief Clase de vector disperso con elección del valor nulo
...
int main(){
    ...
    cout << "Introduzca el valor deseado como nulo: ";
    cin >> nulo;
    
    /* Añadimos al vector elemento, la mayoría de ellos son del valor introducido como nulo */
    vec.push_back(nulo);
    vec.push_back(1);
    vec.push_back(nulo);
    vec.push_back(nulo);
